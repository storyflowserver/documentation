const plugin = (hook, vm) => {
    ...
    function renderChangelog (md) {
      ...
      if (isLS && localStorage.getItem(normalizeMD)) {
        ...
        html = `<a href="javascript:void(0)" onClick="window.changelogDisplayHandler(); return false;" id="CHANGELOG">UPDATES</a>
        ...
        html = `<a href="javascript:void(0)" onClick="window.changelogDisplayHandler(); return false;" id="CHANGELOG"><i id="CHANGELOG_NOTIFY"></i>  UPDATES</a>
                  <div id="CHANGELOG_RENDERER">
                    <div class="CL_content">
                      <div class="CL_content-body"></div>
                    </div>
